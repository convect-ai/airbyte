...
class DreameSAPStream(HttpStream, ABC):
    ...
    def request_headers(
        ...
        return {"Content-Type": "application/json", "Authorization": "Basic " + user_pass_encoded}
    ...
    def request_body_data(
        ...
        body = {"IS_INPUT": {"NAME": self.input_name, "RECEIVER": "SAP", "SENDER": "flow", "INPUT": json.dumps(input_params)}}
...
class InventoryData(IncrementalDreameSAPStream):
    ...
    def request_body_data(self, **kwargs) -> Optional[Union[Mapping, str]]:
        self.input_params = {
            "TABLES": {
                "T_WERKS": [{"LOW": "1100"}, {"LOW": "1101"}, {"LOW": "1102"}, {"LOW": "1111"}],
                "T_LGORT": [
                    {"LOW": "1014"},
                    {"LOW": "1015"},
                    {"LOW": "1016"},
...
class PurchaseOrder(DreameSAPStream):
    ...
    def request_body_data(self, **kwargs) -> Optional[Union[Mapping, str]]:
        ...
        self.input_params = {
            "IMPORT": {"IV_START": iv_start, "IV_END": iv_end},
            "TABLES": {"T_WERKS": [{"LOW": "1100"}, {"LOW": "1101"}, {"LOW": "1102"}, {"LOW": "1111"}]},
        }
        return super().request_body_data(**kwargs)
...
class Bom(DreameSAPStream):
    ...
    def request_body_json(self, stream_slice: Mapping[str, Any] = None, **kwargs) -> Optional[Mapping]:
        ...
        self.input_params = {"IMPORT": {"IV_MATNR": iv_matnr, "IV_WERKS": factory}}
