...
import pytest
from source_shipout.source import ShipoutStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ShipoutStream, "path", "v0/example_endpoint")
    mocker.patch.object(ShipoutStream, "primary_key", "test_primary_key")
    mocker.patch.object(ShipoutStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = ShipoutStream()
